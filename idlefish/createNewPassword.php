...
<head>
    ...
    <link href="static/resetPassword.css" rel="stylesheet" type="text/css" media="all"/>
...
<div class="elelment">
    ...
    <div class="element-main">
        <h1 style="color: #2F2F2F">Forgot Password</h1>
        <p> You can reset your password here.</p>
        <form action="backendScript/resetPassword_process.php" method="POST">
            <input type="hidden" name="selector" value="<?php echo($selector); ?>">
            <input type="hidden" name="validator" value="<?php echo($validator); ?>">

            <input type="password" name="password" placeholder="Password" onfocus="this.value = '';" onblur="if (this.value == ' ') {this.value = 'New password';}">
            <input type="password" name="confirmPassword" placeholder="Confirm Password" onfocus="this.value = '';" onblur="if (this.value == ' ') {this.value = 'Confirm Password';}">

     
            <input type="submit" name = "resetPassword" value="Reset my Password" >
        </form>
        <?php
