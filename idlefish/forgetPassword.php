...
<div class="elelment">
	...
	<div class="element-main">
		...
		<form action="backendScript/forgetPassword_process.php" method="POST">
		  	<?php
		  		if ( isset($_GET['email']) ) {
		  			$email = $_GET['email'];
			...
			if ( !isset($_GET['reset']) ) {
				...
				switch ($resetCheck) {
					case 'error':
						...
						break;
	                case 'empty':
	                    echo "<p style='color:red;'>Please enter a email first</p>";
	                    break;
	                case 'invalidemail':
	                ...
	                case 'noUser':
	                    ...
	                    break;
	                case 'success':
	                    echo "<p style='color:blue;'>Reset password email has been sent.</p>";
	                    break;
				}
			}
